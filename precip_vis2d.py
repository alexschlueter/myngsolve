...
# svis.vec.FV().NumPy()[:] = ss[-1]
vtk = VTKOutputQuad(ma=mesh,coefs=[svis.components[1],svis.components[0]],names=["e","c"],filename="precip_ngsolve/precip_ngsolve",subdivision=0)
# vtk.Do()
import time
input('Press any key...\n\n')
t = 0.0
